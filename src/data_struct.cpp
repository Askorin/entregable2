...
data_struct::data_struct()
    : university(), user_id(), username(), n_tweets(), friend_count(),
      follower_count(), created_at() {}

data_struct::data_struct(std::string university, unsigned long long user_id,
...
bool data_struct::operator==(const data_struct& data) {
    if (this->university != data.university || this->user_id != data.user_id ||
        this->username != data.username || this->n_tweets != data.n_tweets ||
